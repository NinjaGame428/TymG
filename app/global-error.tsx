        ...
        <div className="container mx-auto px-4">
          <section className="py-8 px-4 text-center">
            <div className="max-w-auto mx-auto">
              ...
              <h2 className="mt-8  text-xl lg:text-5xl font-black">{t("error.message") || "Something went wrong!"}</h2>
              <p className="my-2  text-sm lg:text-base text-gray-900">{t("error.description") || "An unexpected error occurred. Please try again."}</p>
              <Button onClick={reset}>{t("reset") || "Try again"}</Button>
            </div>
          </section>
        </div>
      </body>
