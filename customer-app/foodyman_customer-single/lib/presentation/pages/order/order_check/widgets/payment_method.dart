                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          (state.onlinePayments.isNotEmpty)
                              ? ListView.builder(
                                  physics: const NeverScrollableScrollPhysics(),
                                  shrinkWrap: true,
                                  itemCount: state.onlinePayments.length,
                                  itemBuilder: (context, index) {
                                    return SelectItem(
                                      onTap: () {
                                        event.changePayment(
                                            state.onlinePayments[index]);
                                        if (widget.payLater == null &&
                                            widget.tips == null) {
                                          context.maybePop();
                                        }
                                      },
                                      isActive: state.selectPaymentData?.id ==
                                          state.onlinePayments[index].id,
                                      title: AppHelpers.getTranslation(
                                        state.onlinePayments[index].tag ?? "",
                                      ),
                                      colors: widget.colors,
                                    );
                                  },
                                ...
                                ? ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return SelectItem(
                                        ...
                                        isActive: state.currentIndex == index,
                                        title: AppHelpers.getTranslation(ref
                                                .watch(shopProvider)
                                                .shopData
                                                ?.shopPayments?[index]
                                                ?.payment
