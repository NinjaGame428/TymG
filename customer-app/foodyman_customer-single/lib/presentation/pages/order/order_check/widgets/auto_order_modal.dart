...
import 'package:riverpodtemp/application/auto_order/auto_order_provider.dart';
...
import '../../../../../infrastructure/models/data/repeat_data.dart';
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: Row(
                                children: [
                                  Text(
                                    TimeService.dateFormatDMYs(state.from),
                                    style: const TextStyle(fontSize: 18),
                                  ),
                                  const SizedBox(
                                    width: 3,
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: Row(
                                children: [
                                  Text(
                                    TimeService.dateFormatDMYs(state.to),
                                    style: const TextStyle(fontSize: 18),
                                  ),
                                  const SizedBox(
                                    width: 3,
