...
class _ViewMapModalState extends ConsumerState<ViewMapModal> {
  ...
  void initState() {
    ...
    house = TextEditingController(text: widget.address?.address?.house);
    floor = TextEditingController(text: widget.address?.address?.floor);
    super.initState();
  }
            ...
            child: CustomButton(
              ...
              onPressed: () {
                if (widget.isShopLocation) {
                  ...
                  if (state.isActive) {
                    final addressNewModel = AddressNewModel(
                      title: office.text,
                      address: AddressInformation(
                        address: state.placeOne?.address?.address ?? "",
                        floor: floor.text,
                        house: house.text,
                      ),
                      location: [
                        state.placeOne?.location?.firstOrNull,
                        state.placeOne?.location?.lastOrNull,
                      ],
                      createdAt: state.placeOne?.createdAt,
                      updatedAt: state.placeOne?.updatedAt,
                      userId: state.placeOne?.userId,
                      id: state.placeOne?.id,
                      active: state.placeOne?.active,
                    );
                    ref.read(homeProvider.notifier)
                      ...
                      ..fetchCategoriesPage(context, RefreshController(),
                          isRefresh: true)
                      ..setAddress(addressNewModel);
                    LocalStorage.setAddressSelected(
                      state.placeOne?.copyWith(
