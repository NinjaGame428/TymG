...
class BonusScreen extends StatelessWidget {
  ...
  const BonusScreen({super.key, required this.bonus, required this.colors});
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                bonus != null
                    ? ((bonus?.type ?? "sum") == "sum")
                        ? "${bonus?.bonusStock?.product?.translation?.title ?? ""} ${AppHelpers.getTranslation(TrKeys.giftBuy)} ${AppHelpers.numberFormat(bonus?.value ?? 0)}"
