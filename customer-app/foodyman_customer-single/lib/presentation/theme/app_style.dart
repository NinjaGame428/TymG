...
abstract class AppStyle {
  ...
  static const Color locationButtonColor = Color(0xFFF4F4F6);
  ...
  static const Color buttonColor = Color(0xFFF4F4F6);

  static const Color primary = Color(0xFF83EA00);
  static const Color hinTextColor = Color(0xFF88887E);
  ...
  static const Color border = Color(0xFF2E3456);
  static const Color yellow = Color(0xFFFECC47);
  ...
  static const Color maleButtonColor = Color(0xFF989898);
  static const Color editButtonIcon = Color(0xFFC0C2CC);
  static const Color commentCountColor = Color(0xFF307083);
  static const Color searchBorderColor = Color(0xFF2E3456);
  static const Color tabTextLabelColor = Color(0xFF88887E);
  static final Color lineColor = Color(0xFFE0E0E0);
  static final Color colorFilterButtonColor = Color(0xFFF9F9F6);
  static final Color stockColor = Color(0xFF3569B8);
  static const Color categoryDark = Color(0xff33393F);
  static const Color inputColor = Color(0xffF2F2F2);
  static final Color white50 = white.withOpacity(.5);

  /// dark theme based colors
  static const Color scaffoldColorDark = Color(0xFF282E33);
  static const Color socialButtonDark = Color(0xFF373E45);
  static const Color locationItemDark = Color(0xFF353C43);
  static const Color locationNavigatorDark = Color(0xFF282E33);
  static const lightPink = Color(0xFFFAEBED);
