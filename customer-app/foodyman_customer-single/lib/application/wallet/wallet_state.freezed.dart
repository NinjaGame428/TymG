...
mixin _$WalletState {
  ...
  List<TransactionDataTwo> get transactions =>
...
abstract class $WalletStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<TransactionDataTwo> transactions});
}
...
class _$WalletStateImpl implements _WalletState {
  const _$WalletStateImpl(
      ...
      final List<TransactionDataTwo> transactions = const []})
      : _payments = payments,
  ...
  final List<TransactionDataTwo> _transactions;
  @override
  @JsonKey()
  List<TransactionDataTwo> get transactions {
...
abstract class _WalletState implements WalletState {
  const factory _WalletState(
      ...
      final bool isMaksekeskusLoading,
      final MaksekeskusData? maksekeskus,
      final List<TransactionDataTwo> transactions}) = _$WalletStateImpl;
