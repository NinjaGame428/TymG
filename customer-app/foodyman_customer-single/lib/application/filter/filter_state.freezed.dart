...
class _$FilterStateImpl extends _FilterState {
  ...
  @override
  String toString() {
    return 'FilterState(filterModel: $filterModel, freeDelivery: $freeDelivery, deals: $deals, open: $open, shopCount: $shopCount, endPrice: $endPrice, isLoading: $isLoading, isTagLoading: $isTagLoading, isShopLoading: $isShopLoading, isProductLoading: $isProductLoading, rangeValues: $rangeValues, shops: $shops, tags: $tags, prices: $prices, products: $products)';
  }
...
abstract class _FilterState extends FilterState {
  const factory _FilterState(
      ...
      final List<ProductData> products}) = _$FilterStateImpl;
