...
import 'package:riverpodtemp/infrastructure/models/response/recipes_paginate_response.dart';
import 'package:riverpodtemp/infrastructure/models/response/single_recipe_response.dart';
...
class ProductsRepository implements ProductsRepositoryFacade {
  ...
  Future<ApiResult<CategoriesPaginateResponse>> getRecipeCategoriesPaginate({
    ...
    final data = {
      ...
      "r_shop_id": LocalStorage.getShopId(),
      "receipt-count": 1
    };
    try {
      final client = inject<HttpService>().client(requireAuth: false);
