...
import 'package:riverpodtemp/infrastructure/models/data/coupon_data.dart';
import 'package:riverpodtemp/infrastructure/models/data/refund_data.dart';
import 'package:riverpodtemp/infrastructure/models/data/repeat_data.dart';
import 'package:riverpodtemp/infrastructure/models/data/transaction_model.dart';
...
class OrderActiveModel {
  ...
  List<TransactionDataNew>? transactions;
  ...
  factory OrderActiveModel.fromJson(Map<String, dynamic> json) =>
      OrderActiveModel(
        ...
        address: AddressInformation.fromJson(json["data"]["address"]),
        ...
        transactions: json["data"]["transactions"] == null
            ? []
            : List<TransactionDataNew>.from(
                json["data"]["transactions"].map(
                  (x) => TransactionDataNew.fromJson(x),
                ),
              ),
      );
  ...
  factory OrderActiveModel.fromJsonWithoutData(Map<String, dynamic> json) {
    return OrderActiveModel(
      ...
      address: AddressInformation.fromJson(json["address"]),
