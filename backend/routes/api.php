...
//    Route::get('/login/{provider}',                 [LoginController::class,'redirectToProvider']);
    ...
    Route::group(['prefix' => 'dashboard'], function () {
        ...
        Route::group(['prefix' => 'user', 'middleware' => ['sanctum.check'], 'as' => 'user.'], function () {
            ...
            /* rest payments */
            Route::any('split-stripe-process', 		 [Payment\StripeController::class, 		'splitTransaction']);
            Route::any('split-razorpay-process', 	 [Payment\RazorPayController::class,  	'splitTransaction']);
            Route::any('split-mercado-pago-process', [Payment\MercadoPagoController::class, 'splitTransaction']);
            Route::any('split-paystack-process', 	 [Payment\PayStackController::class,  	'splitTransaction']);
            Route::any('split-paypal-process', 		 [Payment\PayPalController::class, 	 	'splitTransaction']);
            Route::any('split-flutter-wave-process', [Payment\FlutterWaveController::class, 'splitTransaction']);
            Route::any('split-paytabs-process', 	 [Payment\PayTabsController::class,  	'splitTransaction']);
            Route::any('split-moya-sar-process', 	 [Payment\MoyasarController::class,  	'splitTransaction']);
            Route::any('split-mollie-process', 	     [Payment\MollieController::class, 	 	'splitTransaction']);
            Route::any('split-maksekeskus-process',  [Payment\MaksekeskusController::class, 'splitTransaction']);
        ...
        Route::group(['prefix' => 'admin', 'middleware' => ['sanctum.check', 'role:seller|manager'], 'as' => 'admin.'], function () {
            ...
            Route::post('products/parent/sync',          [Admin\ProductController::class, 'parentSync']);
