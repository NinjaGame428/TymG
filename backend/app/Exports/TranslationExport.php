...
{
    public function __construct(private ?array $languages = null, private array $data = [])
    {
        $this->languages = Translation::pluck('locale', 'locale')->toArray();
    }
    ...
    private function tableBody(Translation $translation): array
    {
        ...
        if (!in_array($translation->locale, $this->languages)) {
